...
big_H = 0.5; small_h = 0.05  #0.025 0.05
...
def substep():
    ...
    for i, j in grid_m:
        if grid_m[i, j] > 0:  # No need for epsilon here
            ...
            grid_v[i, j][1] -= dt * 10  # gravity 50 10
...
initialize()
# x_numpy=x.to_numpy()
# hauteur_moyenne_debut=np.mean(x_numpy[n_particles_core:,1])
# print("hauteur_moyenne = ", hauteur_moyenne_debut)
...
# hauteur_moyenne_fin=np.mean(x_numpy[n_particles_core:,1])
# print("hauteur_moyenne = ", hauteur_moyenne_fin)
